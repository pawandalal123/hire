  ...
  <div class="row">
    <div class="col s12 m8 l8">
      <div class="row">
          ...
          <p style="color: green;" class="alert alert-{{ Session::get('alert-class', 'alert-success') }}">{{ Session::get('message') }}</p>
          @endif
          ...
          <div class="article-hire-sidebar contact-form">
           ...
           <!--  {!! Form::submit('Contact', array('class' => 'waves-effect waves-light btn article-hire-button')) !!} -->
            <input type="submit" name="submitcontact" class="waves-effect waves-light btn article-hire-button">
          </div>
           {!! Form::close() !!}
        </div>
    </div>
