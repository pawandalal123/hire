    ...
    <div class="col s12 m8 l8">
      <div class="row">
          ...
          @if($login==1)
            ...
            <a class="waves-effect waves-light btn article-hire-button cooment-butt" href="javascript::void(0)" onclick="savecomment('{{$articledetail->id}}','news')" rel="article">Comment</a>
            <!-- Modal Structure -->
            @else
            <div class="input-field">
