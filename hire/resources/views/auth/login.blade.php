...
<div class="input-field col s4">
         ...
         <div class="input-field col s4">
             ...
             <div class="input-field col s4">
                <button type="submit" class="btn btn-primary red" >Login / Register</button>
                <!-- <button type="submit" class="btn btn-primary red" >Register</button> -->
                ...
                <a class="btn-floating waves-effect waves-light login-fb red" href="{{URL::to('sociallogin/google')}}"><img src="http://hiremedev.slugcorner.com/web/site/images/google-plus.png"></a>
