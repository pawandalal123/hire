...
class RepositoryServiceProvider extends ServiceProvider {
    ...
    public function register()
    {
        ...
        $this->app->bind('Appfiles\Repo\EmploymentInterface', 'Appfiles\Repo\EmploymentRepository');
        $this->app->bind('Appfiles\Repo\PostnewsInterface', 'Appfiles\Repo\PostnewsRepository');
